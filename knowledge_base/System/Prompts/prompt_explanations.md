---
{title: Prompt_Explanations, type: System, up: '[[System/Prompts]]'}
---
# Brief one-line summary from AI analysis of what each prompt does

- Key prompt to use: **suggest_prompt**, suggests appropriate prompts or commands based on user input.
...
57. **create_diy**: Creates structured "Do It Yourself" tutorial prompts by analyzing prompts, organizing requirements, and providing step-by-step instructions in Markdown format.
...
77. **create_prompt**: Extracts, organizes, and formats LLM/AI prompts into structured sections, detailing the AI's role, instructions, output format, and any provided examples for clarity and accuracy.
...
168. **official_prompt_template**: Template to use if you want to create new prompts.
...
184. **suggest_prompt**: Suggests appropriate prompts or commands based on user input, providing clear explanations and options for users.
