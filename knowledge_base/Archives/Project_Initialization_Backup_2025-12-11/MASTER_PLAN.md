---
{title: Master_Plan, type: Note}
---
{# LifeOS Master Plan (Revised)
**Version**: 2.0  
**Date**: 2025-11-20  
...
**Target User**: 60-year-old Roman Catholic father, INTP personality, managing household/homeschooling.
...
## 4. How PARA and GTD-Tasks Interact

### Projects Are Knowledge Containers

**Example**: `Projects/Active/Family-Projects/College-Prep.md`

```markdown
---
title: "College Prep for Son A"
type: Project
status: Active
...
# College Prep for Son A

## Objective
Get Son A into college with maximum financial aid by November 2026.

## Milestones
- [ ] Complete FAFSA by February 1, 2026
- [ ] Visit 5 campuses by March 15, 2026
- [ ] Submit applications by November 1, 2026

## Current Tasks
<!-- Links to GTD-Tasks -->
- [[GTD-Tasks/1-Next-Actions/research-financial-aid-options.md]]
- [[GTD-Tasks/1-Next-Actions/schedule-campus-visits.md]]
- [[GTD-Tasks/2-Waiting-For/recommendation-letter-math-teacher.md]]

## Related Resources
- [[Resources/Books/College-Financial-Planning-Guide.md]]
- [[Resources/People/College-Counselor-Jane.md]]
- [[Resources/Articles/FAFSA-vs-CSS-Profile.md]]

## Notes
Started Nov 2025. Son A is interested in engineering programs...
```

### Tasks Link Back to Projects

**Example**: `GTD-Tasks/1-Next-Actions/research-financial-aid-options.md`

```markdown
---
title: "Research college financial aid options"
status: Next-Action
project: [[Projects/Active/Family-Projects/College-Prep]]
area: [[System/MOCs/Family]]
...
## Action
Compare FAFSA vs CSS Profile requirements for Son A's college list.

## Why It Matters
Understanding aid requirements early maximizes chances of financial support.
Aligns with Family value of preparing children for independent future.

## Next Steps
1. Visit finaid.org comparison page
2. Create spreadsheet of requirements by college
3. Note deadlines in family calendar
4. Discuss with wife during weekly review

## Related
- [[Projects/Active/Family-Projects/College-Prep]]
- [[Resources/People/Son-A]]
- [[Areas/Family/Financial-Stewardship]]
```
